 ...
 */
export const add = 'Adăugare';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Elimină';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Elimină tot';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Pare rău, unele câmpuri nu sunt corect completate.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Trimite';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nu este selectat nici un fișier';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Mutare în sus';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Mutare în jos';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Se încarcă...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Încărcați mai mult';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Urmatorul';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Precedent';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Adăugați toate valorile';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Adăugarea valorilor selectate';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Eliminați toate valorile';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Eliminați valorile selectate';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Alege data';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Modificați data';
/**
 * Shown when there is something to close
 */
export const close = 'Închide';
/**
 * Shown when there is something to open.
 */
export const open = 'Deschis';
/**
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} trebuie să fie între ${date(args[0])} și ${date(args[1])}`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Te rog folosește o adresă de email validă.';
/**
 ...
 */
export const invalidDate = 'Data selectată este nevalidă.';
/**
