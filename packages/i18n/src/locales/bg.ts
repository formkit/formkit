 ...
 */
export const add = 'Добави';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Премахни';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Премахни всички';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Извинете, не всички полета са попълнени правилно.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Изпрати';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Няма избран файл';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Преместване нагоре';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Преместете се надолу';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Зареждане...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Заредете повече';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Следващ';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Предишен';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Добавете всички стойности';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Добавяне на избрани стойности';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Премахнете всички стойности';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Премахване на избраните стойности';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Избери дата';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Промяна на датата';
/**
 ...
 */
export const email = 'Моля, въведете валиден имейл адрес.';
/**
 ...
 */
export const invalidDate = 'Избраната дата е невалидна.';
/**
