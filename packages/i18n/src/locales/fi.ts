 ...
 */
export const removeAll = 'Poista kaikki';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Kaikkia kenttiä ei ole täytetty oikein.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Tallenna';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Ei valittuja tiedostoja';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Siirrä ylös';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Siirrä alas';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Ladataan...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Lataa lisää';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Seuraava';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Edellinen';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Lisää kaikki arvot';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Lisää valitut arvot';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Poista kaikki arvot';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Poista valitut arvot';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Valitse päivämäärä';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Vaihda päivämäärä';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} ei ole validi päivämäärä, ole hyvä ja syötä muodossa: ${args[0]}`;
    /* </i18n> */
  }
 ...
 */
export const email = 'Syötä validi sähköpostiosoite.';
/**
 ...
 */
export const invalidDate = 'Valittu päivämäärä on virheellinen.';
/**
