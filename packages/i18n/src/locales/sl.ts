 ...
 */
export const remove = 'Odstrani';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Odstrani vse';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Nekatera polja niso pravilno izpolnjena.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Pošlji';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nobena datoteka ni izbrana';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Premakni se navzgor';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Premakni se navzdol';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Nalaganje...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Naloži več';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Naslednji';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Prejšnji';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Dodajte vse vrednosti';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Dodajanje izbranih vrednosti';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Odstranite vse vrednosti';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Odstrani izbrane vrednosti';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Izberite datum';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Spremeni datum';
/**
 * Shown when there is something to close
 */
export const close = 'Zapri';
/**
 * Shown when there is something to open.
 */
export const open = 'Odpri';
/**
 ...
 */
export const email = 'Vnesite veljaven e-poštni naslov.';
/**
 ...
 */
export const invalidDate = 'Izbrani datum je neveljaven.';
/**
