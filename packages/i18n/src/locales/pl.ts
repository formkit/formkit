 ...
 */
export const removeAll = 'Usuń wszystko';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Nie wszystkie pola zostały wypełnione poprawnie.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Wyślij';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nie wybrano pliku';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Przesuń w górę';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Przesuń w dół';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Ładowanie...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Załaduj więcej';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Kolejny';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Poprzednia';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Dodaj wszystkie wartości';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Dodaj wybrane wartości';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Usuń wszystkie wartości';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Usuń wybrane wartości';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Wybierz datę';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Zmień datę';
/**
 ...
 */
export const email = 'Proszę wpisać poprawny adres email.';
/**
 ...
 */
export const invalidDate = 'Wybrana data jest nieprawidłowa.';
/**
