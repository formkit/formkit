 ...
 */
export const add = 'Pridėti';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Pašalinti';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Pašalinti visus';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Atsiprašome, ne visi laukai užpildyti teisingai.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Pateikti';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nepasirinktas joks failas';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Aukštyn';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Žemyn';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Kraunama...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Daugiau';
/**
 * Show on buttons that navigate state forward
 */
export const next = 'Kitas';
/**
 * Show on buttons that navigate state backward
 */
export const prev = 'Ankstesnis';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Pridėti visas reikšmes';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Pridėti pasirinktas reikšmes';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Pašalinti visas reikšmes';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Pašalinti pasirinktas reikšmes';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Pasirinkti datą';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Pakeisti datą';
/**
 * Shown when there is something to close
 */
export const close = 'Uždaryti';
/**
 * Shown when there is something to open.
 */
export const open = 'Atidaryti';
/**
 ...
 */
export const email = 'Įveskite teisingą el. pašto adresą.';
/**
 ...
 */
export const invalidDate = 'Pasirinkta data yra netinkama.';
/**
