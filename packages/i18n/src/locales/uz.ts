 ...
 */
export const add = "Qo'shish";
/**
 * Shown when a button to remove items is visible.
 */
export const remove = "O'chirish";
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = "Hammasini o'chirish";
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = "Kechirasiz, barcha maydonlar to'g'ri to'ldirilmagan.";
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Yuborish';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Hech qanday fayl tanlanmagan';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Yuqoriga ko’taring';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Pastga siljish';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Yuklanmoqda...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Ko’proq yuklang';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Keyingi';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Oldingi';
/**
 * Shown when adding all values.
 */
export const addAllValues = `Barcha qiymatlarni qo'shish`;
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = `Tanlangan qiymatlarni qoʻshish`;
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Barcha qiymatlarni olib tashlang';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Tanlangan qiymatlarni olib tashlash';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Sanani tanlang';
/**
 * Shown when there is a date to change.
 */
export const changeDate = `O'zgartirish sanasi`;
/**
 * Shown when there is something to close
 */
export const close = 'Yopish';
/**
 * Shown when there is something to open.
 */
export const open = 'Ochiq';
/**
 ...
 */
export const email = 'Iltimos amaldagi e-mail manzilingizni kiriting.';
/**
 ...
 */
export const invalidDate = 'Tanlangan sana yaroqsiz.';
/**
