 ...
 */
export const submit = 'Predaj';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Pomaknite se gore';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Pomakni se dolje';
/**
 ...
 */
export const addSelectedValues = 'Dodavanje odabranih vrijednosti';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Ukloni sve vrijednosti';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Ukloni odabrane vrijednosti';
/**
 ...
 */
export const changeDate = 'Promijeni datum';
/**
 * Shown when there is something to close
 */
export const close = 'Zatvoriti';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} nije ispravan format datuma. Molimo koristite sljedeći format: ${args[0]}`;
    /* </i18n> */
  }
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} mora biti vrijednost između ${date(args[0])} i ${date(args[1])}`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Molimo upišite ispravnu email adresu.';
/**
