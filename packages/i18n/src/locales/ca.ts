 ...
 */
export const incomplete = 'Disculpi, no tots els camps estan omplerts correctament.';
/**
 ...
 */
export const noFiles = 'Cap fitxer triat';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Moure amunt';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Moure avall';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Carregant...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Carregar més';
/**
 ...
 */
export const addAllValues = 'Afegir tots els valors';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Afegeix els valors seleccionats';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Eliminar tots els valors';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Elimina els valors seleccionats';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Trieu la data';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Canviar data';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} no és una data vàlida, si us plau empri el format ${args[0]}`;
    /* </i18n> */
  }
 ...
 */
export const email = `Si us plau, entri una adreça d'e-mail vàlida.`;
/**
 ...
 */
export const invalidDate = 'La data seleccionada no és vàlida.';
/**
