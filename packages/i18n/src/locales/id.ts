 ...
 */
export const remove = 'Hapus';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Hapus semua';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Maaf, tidak semua bidang formulir terisi dengan benar';
/**
 ...
 */
export const noFiles = 'Tidak ada file yang dipilih';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Pindah ke atas';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Pindah ke bawah';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Memuat...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Muat lebih';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Berikutnya';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Sebelumnya';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Tambahkan semua nilai';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Tambahkan nilai yang dipilih';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Hapus semua nilai';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Hapus nilai yang dipilih';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Pilih tanggal';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Ubah tanggal';
/**
 * Shown when there is something to close
 */
export const close = 'Tutup';
/**
 * Shown when there is something to open.
 */
export const open = 'Buka';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} waktu tidak cocok, mohon gunakan format waktu ${args[0]}`;
    /* </i18n> */
  }
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} harus diantara waktu ${date(args[0])} dan waktu ${date(args[1])}`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Tolong tulis alamat email yang benar.';
/**
...
export const length: FormKitValidationMessage = function ({
  ...
  if (min == 0 && max) {
    ...
    return `${s(name)} jumlah karakternya harus kurang dari atau sama dengan ${max} karakter.`;
    /* </i18n> */
  }
  if (min === max) {
  ...
  if (min && max === Infinity) {
    ...
    return `${s(name)} jumlah karakternya harus lebih dari atau sama dengan ${min} karakter.`;
    /* </i18n> */
  }
  /* <i18n case="Shown when the length of the user-provided value is between the two lengths supplied to the rule."> */
  return `${s(name)} jumlah karakternya hanya bisa antara ${min} dan ${max} karakter.`;
  /* </i18n> */
};
/**
 ...
 */
export const invalidDate = 'Tanggal yang dipilih tidak valid.';
/**
