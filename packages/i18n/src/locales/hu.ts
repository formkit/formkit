 ...
 */
export const add = 'Hozzáadás';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Eltávolítás';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Összes eltávolítása';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Sajnáljuk, nem minden mező lett helyesen kitöltve.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Beküldés';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nincs fájl kiválasztva';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Mozgás felfelé';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Mozgás lefelé';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Betöltés...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Töltsön be többet';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Következő';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Előző';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Adja hozzá az összes értéket';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Kiválasztott értékek hozzáadása';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Távolítsa el az összes értéket';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'A kiválasztott értékek eltávolítása';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Válassza ki a dátumot';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Dátum módosítása';
/**
 * Shown when there is something to close
 */
export const close = 'Bezárás';
/**
 * Shown when there is something to open.
 */
export const open = 'Nyitott';
/**
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} mezőnek ${date(args[0])} és ${args[1]} között kell lennie`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Kérjük, érvényes email címet adjon meg.';
/**
 ...
 */
export const invalidDate = 'A kiválasztott dátum érvénytelen.';
/**
