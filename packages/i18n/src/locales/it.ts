...
export const validation: FormKitValidationMessages = {
  ...
  accepted({ name }): string {
    ...
    return `Per favore accetta il ${name}.`
    /* </i18n> */
  },
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      ...
      return `${s(name)} deve essere dopo ${date(args[0])}.`
      /* </i18n> */
    }
    /* <i18n case="Shown when the user-provided date is not after today's date, since no date was supplied to the rule."> */
    return `${s(name)} deve essere nel futuro.`
    /* </i18n> */
  },
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      ...
      return `${s(name)} deve essere prima ${date(args[0])}.`
      /* </i18n> */
    }
  ...
  between({ name, args }) {
    ...
    return `${s(name)} deve essere compreso tra ${a} e ${b}.`
    /* </i18n> */
  },
  ...
  date_between({ name, args }) {
    ...
    return `${s(name)} deve essere compreso tra ${date(args[0])} e ${date(args[1])}`
    /* </i18n> */
  },
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    return `${s(name)} deve contenere tra ${min} e ${max} caratteri.`
    /* </i18n> */
  },
  ...
  not({ name, node: { value } }) {
    ...
    return `“${value}” non è consentito ${name}.`
    /* </i18n> */
  },
