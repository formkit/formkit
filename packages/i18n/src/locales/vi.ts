 ...
 */
export const remove = 'Xoá';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Xoá tất cả';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Xin lỗi, không phải tất cả các trường đều được nhập đúng.';
/**
 ...
 */
export const noFiles = 'Chưa chọn file';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Di chuyển lên';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Di chuyển xuống';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Đang tải...';
/**
 ...
 */
export const prev = 'Trước';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Thêm tất cả các giá trị';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Thêm các giá trị đã chọn';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Loại bỏ tất cả các giá trị';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Loại bỏ các giá trị đã chọn';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Chọn ngày';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Thay đổi ngày';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} không phải ngày hợp lệ, hãy sử dụng định dạng ${args[0]}`;
    /* </i18n> */
  }
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} phải ở giữa khoảng từ ${date(args[0])} đến ${date(args[1])}.`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Hãy nhập một địa chỉ email hợp lệ.';
/**
...
export const length: FormKitValidationMessage = function ({
  ...
  return `${s(name)} phải có độ dài tối đa trong khoảng từ ${min} đến ${max} ký tự.`;
  /* </i18n> */
};
/**
 ...
 */
export const invalidDate = 'Ngày đã chọn không hợp lệ.';
/**
