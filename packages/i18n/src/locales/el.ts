 ...
 */
export const add = 'Προσθήκη';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Αφαίρεση';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Αφαίρεση όλων';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Λυπούμαστε, υπάρχουν πεδία που δεν έχουν συμπληρωθεί σωστά.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Υποβολή';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Κανένα αρχείο δεν έχει επιλεγεί';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Προς τα επάνω';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Προς τα κάτω';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Φορτώνει...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Φόρτωση περισσότερων';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Επόμενη';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Προηγούμενο';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Προσθήκη όλων των τιμών';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Προσθήκη επιλεγμένων τιμών';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Κατάργηση όλων των τιμών';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Αφαίρεση επιλεγμένων τιμών';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Επιλέξτε ημερομηνία';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Αλλαγή ημερομηνίας';
/**
 * Shown when there is something to close
 */
export const close = 'Κλείσιμο';
/**
 * Shown when there is something to open.
 */
export const open = 'Ανοιχτό';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} δεν είναι έγυρη ημερομηνία, παρακαλώ ακολουθήστε την διαμόρφωση ${args[0]}`;
    /* </i18n> */
  }
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} πρέπει να είναι μεταξύ ${date(args[0])} και ${date(args[1])}`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Παρακαλώ πληκτρολογήστε μια έγκυρη email διεύθυνση. ';
/**
...
export const length: FormKitValidationMessage = function ({
  ...
  if (min && max === Infinity) {
    ...
    return `${s(name)} πρέπει να είναι περισσότεροι ή ίσοι με ${min} χαρακτήρες.`;
    /* </i18n> */
  }
 ...
 */
export const invalidDate = 'Η επιλεγμένη ημερομηνία δεν είναι έγκυρη.';
/**
