 ...
 */
export const remove = 'מחק';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'מחק הכל';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'שים לב, לא כל השדות מלאים כראוי.';
/**
 ...
 */
export const noFiles = 'לא נבחר קובץ..';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'הזז למעלה';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'הזז למטה';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'טוען...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'טען יותר';
/**
 ...
 */
export const prev = 'הקודם';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'הוסף את כל הערכים';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'הוספת ערכים נבחרים';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'הסר את כל הערכים';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'הסר ערכים נבחרים';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'בחר תאריך';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'שינוי תאריך';
/**
 ...
 */
export const email = 'אנא הקלד אימייל תקין.';
/**
 ...
 */
export const invalidDate = 'התאריך שנבחר אינו חוקי.';
/**
