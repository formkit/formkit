 ...
 */
export const remove = 'Odstrániť';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Odstrániť všetko';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Prepáčte, ale nie všetky polia sú vyplnené správne.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Odoslať';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Nebol vybraný žiadny súbor';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Posunúť hore';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Posunúť dole';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Načítavanie...';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Načítať viac';
/**
 * Shown on buttons that navigate state forward
 */
export const next = 'Ďalšie';
/**
 * Shown on buttons that navigate state backward
 */
export const prev = 'Predošlý';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Pridajte všetky hodnoty';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Pridajte vybrané hodnoty';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Odstrániť všetky hodnoty';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Odstrániť vybrané hodnoty';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Vyberte dátum';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Zmena dátumu';
/**
 ...
 */
export const email = 'Prosím, zadajte platnú emailovú adresu.';
/**
 ...
 */
export const invalidDate = 'Vybraný dátum je neplatný.';
/**
