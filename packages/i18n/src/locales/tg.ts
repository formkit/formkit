 ...
 */
export const add = 'Илова кардан';
/**
 * Shown when a button to remove items is visible.
 */
export const remove = 'Хориҷ кардан';
/**
 * Shown when there are multiple items to remove at the same time.
 */
export const removeAll = 'Ҳамаро хориҷ кунед';
/**
 * Shown when all fields are not filled out correctly.
 */
export const incomplete = 'Бубахшед, на ҳама майдонҳо дуруст пур карда шудаанд.';
/**
 * Shown in a button inside a form to submit the form.
 */
export const submit = 'Пешниҳод кунед';
/**
 * Shown when no files are selected.
 */
export const noFiles = 'Ягон файл интихоб нашудааст';
/**
 * Shown on buttons that move fields up in a list.
 */
export const moveUp = 'Ба боло ҳаракат кунед';
/**
 * Shown on buttons that move fields down in a list.
 */
export const moveDown = 'Ба поён ҳаракат кунед';
/**
 * Shown when something is actively loading.
 */
export const isLoading = 'Дар ҳоли боргузорӣ';
/**
 * Shown when there is more to load.
 */
export const loadMore = 'Бештар бор кунед';
/**
 * Show on buttons that navigate state forward
 */
export const next = 'Баъдӣ';
/**
 * Show on buttons that navigate state backward
 */
export const prev = 'Гузашта';
/**
 * Shown when adding all values.
 */
export const addAllValues = 'Ҳама арзишҳоро илова кунед';
/**
 * Shown when adding selected values.
 */
export const addSelectedValues = 'Илова кардани арзишҳои интихобшуда';
/**
 * Shown when removing all values.
 */
export const removeAllValues = 'Ҳама арзишҳоро хориҷ кунед';
/**
 * Shown when removing selected values.
 */
export const removeSelectedValues = 'Арзишҳои интихобшударо хориҷ кунед';
/**
 * Shown when there is a date to choose.
 */
export const chooseDate = 'Сана интихоб кунед';
/**
 * Shown when there is a date to change.
 */
export const changeDate = 'Тағйир додани сана';
/**
...
export const date_format: FormKitValidationMessage = function ({
  ...
  if (Array.isArray(args) && args.length) {
    ...
    return `${s(name)} санаи дуруст нест, лутфан формати ${args[0]}-ро истифода баред`;
    /* </i18n> */
  }
...
export const date_between: FormKitValidationMessage = function ({
  ...
  return `${s(name)} бояд дар байни ${date(args[0])} ва ${date(args[1])} бошад`;
  /* </i18n> */
};
/**
 ...
 */
export const email = 'Лутфан нишонаи имейли амалкунандаро ворид намоед.';
/**
 ...
 */
export const invalidDate = 'Санаи интихобшуда нодуруст аст.';
/**
