...
<template>
  ...
  >
    ...
    <FormKit
      type="number"
      label="Floating Text Label without placeholder"
    />
    <FormKit
      type="number"
      label="Floating Text Label via prop"
      placeholder="I should be hidden"
      validation="number|between:50,2500"
      :floating-label="true"
    />
    <FormKit
      type="email"
    ...
    <FormKit
      type="autocomplete"
      name="country"
      label="Search for many countries"
      multiple
      placeholder="Example: United States"
      :options="countries"
    />
    ...
    <FormKit
      ...
      label="Floating Textarea Label"
      overlay
      placeholder="I have a placeholder & overlay"
    />
    <FormKit
      type="mask"
      name="phone"
